...
class SparkTTSSynthesizer(Synthesizer):
    def __init__(self, model_path: str, config: dict, sr):
        super(SparkTTSSynthesizer, self).__init__(model_path, config, sr, "SparkTTS")
    ...
    def syn(self, ref_audio: torch.Tensor, text: str) -> torch.Tensor:
        ...
        pipe_in = tempfile.mktemp(prefix="SparkTTS_in_", suffix=".wav", dir="/tmp")
        pipe_out = tempfile.mktemp(prefix="SparkTTS_out_", suffix=".wav", dir="/tmp")
